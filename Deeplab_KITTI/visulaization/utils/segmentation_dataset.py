...
def get_dataset(dataset_name, split_name, image_side, dataset_dir):
  ...
  if image_side not in splits_to_sizes:
      raise ValueError('data split name %s not recognized' % image_side)
  ...
  return dataset.Dataset(
      ...
      decoder=decoder,
      num_samples=splits_to_sizes[image_side],
