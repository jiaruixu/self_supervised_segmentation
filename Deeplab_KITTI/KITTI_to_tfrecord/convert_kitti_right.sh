...
KITTI_LEFT_ROOT="/home/jiarui/git/Dataset/KITTI/training/image_2"
KITTI_RIGHT_ROOT="/home/jiarui/git/Dataset/KITTI/training/image_3"
...
BUILD_SCRIPT="${CURRENT_DIR}/build_kitti_data.py"

echo "Converting KITTI dataset..."
python "${BUILD_SCRIPT}" \
  --kitti_root="${KITTI_RIGHT_ROOT}" \
  --image_side="right" \
