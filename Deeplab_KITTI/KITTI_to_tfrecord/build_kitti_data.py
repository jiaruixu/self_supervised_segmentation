...
tf.app.flags.DEFINE_string('kitti_root',
                           '/mnt/fcav/PASCAL/tracking_610_filter_3/VOC2012/0cb59a00-51b1-4c27-9808-49ee1734bd71/JPEGImages',
                           'GTA dataset root folder.')
...
def _get_files(data, dataset_split):
  ...
  if data == 'label' and dataset_split == 'test':
    return None
  pattern = '*.%s' % (_LEFT_RIGHT_MAP[data])
  search_files = os.path.join(FLAGS.kitti_root, pattern)
